...
document.querySelectorAll(".choice").forEach(e=>e.classList.remove("border-orange-800"))
...
useEffect(() => {
    function setwrapperwidth() {
        innerwrapper.current ? setwrapper(innerwrapper.current.getBoundingClientRect().width ):""
    }
    setwrapperwidth()
...
return (
    <div>
        <div className="container mx-auto xl:flex justify-center gap-3 mb-20 max-md:mt-16 " id="home">
            <div className="intro xl:w-2/5 flex flex-col justify-center  min-h-screen p-3">
                <p className=' text-orange-500 text-2xl font-normal mb-4'>Our Summer collections</p>

                <h1 className=' max-md:text-[4rem] text-[5.5rem] font-bold font-palanquin'>
                    <span className='relative z-40 xl:whitespace-nowrap pr-6  xl:bg-white'>The New Arrival </span> 
                    <br />
                    <span className='text-orange-700'>Nike</span>  Shoes
                </h1>

                <p className=' leading-9 text-2xl text-gray-500'>Discover stylish Nike arrivals, quality <br /> comfort, and innovation for your active life.</p>
                
                <button className='group/shop mb-10 duration-300 hover:translate-y-1 hover:shadow-orange-700 mt-24 bg-orange-700  
                ...
                Shop Now 
                <img className=' transition group-hover/shop:translate-x-2' src={allicons.arrowRight}
            ...
            <div className="shoes  min-h-screen xl:w-2/5 flex flex-col justify-center relative ">
                ...
                <div className="wrapper-toggle flex justify-center gap-5 absolute bottom-5 md:bottom-[-5%]">
                    <div className="choice border-4 border-orange-800" data-range ="0"  onClick={e=>{setactive(e);setrange(e.currentTarget.dataset.range)}} >
                        <img src={allimages.bigShoe1}  className="h-4/5" alt="shoe"  />
                    </div>

                    <div  className="choice  border-4"  data-range ="1"  onClick={e=>{setactive(e);setrange(e.currentTarget.dataset.range)}}  >
                        <img src={allimages.bigShoe2} className="h-4/5" alt="shoe" />
                    </div>

                    <div className="choice  border-4"   data-range ="2" onClick={e=>{setactive(e);setrange(e.currentTarget.dataset.range)}} >
